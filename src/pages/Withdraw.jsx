...
import { TOKEN_DECIMALS, contractId, formatPrice } from "../config/constants";
               ...
               <div className="max-w-md w-full mx-auto sm:mt-20 mt-10">
                    ...
                    <form className="md:text-xl sm:text-lg text-base font-medium mt-2 md:space-y-6 sm:space-y-4 space-y-2">
                         <div className="relative bg-white rounded-lg border border-gray-200 px-3 py-2">
                              ...
                              <input id="from" type="text" disabled={true} value={stats.eligibleWithdrawals ? formatPrice(stats.eligibleWithdrawals/ Math.pow(10,TOKEN_DECIMALS)) : 0} placeholder="0.0" className="md:text-4xl sm:text-3xl text-2xl pt-1 placeholder:text-gray-400" />
